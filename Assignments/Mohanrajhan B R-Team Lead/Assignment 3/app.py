...
COS_API_KEY_ID = "CZju3USKw1VrHF0kQga404R7rysnYtny7UjmuavCVaV_"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/64b86b7b7a62433ca8bb665e9da098e8:aaf94b21-e4b5-42c2-99d8-cdddf831075c::"
...
@app.route('/')
def index():
    file1 = get_bucket_contents('storeacc')
