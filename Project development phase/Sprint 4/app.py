...
api_key = '9532774b9fc1cc989f34dce8cde7d6c6'
api_secret = '13062c5d282ea5f0e960942a8a43369f'
...
def registration(email):
   data = {
      'Messages': [
         {
            "From": {
            "Email": "karthicv3@protonmail.com",
            "Name": "IBM-GCE"
            },
            "To": [
            {
...
def signup():
   if request.method == 'POST':
      ...
      blood_group = (request.form['blood_group']).lower()
      password = request.form['password']
...
def reqform_post():
   ...
   plasmarequest(name,bg,city,hosp)
